    ...
    return (
        ...
        <div className="grid mr-auto max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:z-10">
            ...
            <div className="lg:col-span-7 z-10 flex flex-col items-center lg:block lg:place-self-center">
                ...
                <Link to={user ? '/quiz/create' : '/login'} className="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-violet-500 hover:bg-violet-400 focus:ring-4 focus:ring-primary-300 ">
                    Create Qwiz
